    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-white text-slate-900 selection:bg-blue-100 font-sans">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-[0.03] [mask-image:radial-gradient(ellipse_at_center,white,transparent)]" 
             style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'60\' height=\'60\' viewBox=\'0 0 60 60\' xmlns=\'svg\'%3E%3Cg fill=\'none\' fill-rule=\'evenodd\'%3E%3Cg fill=\'%23000000\' fill-opacity=\'1\'%3E%3Cpath d=\'M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z\'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")' }} 
        />
      </div>
        ...
        <section className="relative flex min-h-[75vh] flex-col justify-center px-6 pt-32 pb-16">
          <div className="mx-auto w-full max-w-7xl">
            <div className="max-w-5xl text-left">
              <TextDisplay className="mb-6 text-slate-900 md:mb-8 md:text-[100px] md:leading-[0.95] tracking-tighter">
                Your AI partner for <br />
                <span className="bg-gradient-to-r from-primary-500 via-blue-400 to-primary-600 bg-clip-text text-transparent italic">
                  Perfect journeys.
                </span>
              </TextDisplay>
              
              <TextSubheading className="mb-12 max-w-2xl text-slate-500/90 leading-relaxed md:text-[28px]">
                Lakbai transforms how you explore Legazpi. Build itineraries, discover local 
                spots, and navigate with ease—all powered by intelligent AI.
              </TextSubheading>
          ...
          <div className="mx-auto max-w-7xl px-4 md:px-6">
            <div className="scrollbar-hide -mx-4 flex snap-x snap-mandatory gap-6 overflow-x-auto px-4 pb-4 md:mx-0 md:grid md:grid-cols-3 md:gap-8 md:px-0 md:pb-0">
              ...
              <div className="group w-[88vw] shrink-0 snap-center rounded-[2.5rem] border border-slate-100 bg-white/60 p-10 backdrop-blur-sm transition-all hover:border-blue-200 hover:bg-white md:w-auto">
                ...
                <TextHeading className="mb-4 text-slate-900">AI Concierge</TextHeading>
                <TextBody className="text-slate-500 leading-relaxed text-base">
                  Smart chat assistance that understands your preferences and plans your day instantly.
                </TextBody>
              </div>
              ...
              <div className="group w-[88vw] shrink-0 snap-center rounded-[2.5rem] border border-slate-100 bg-white/60 p-10 backdrop-blur-sm transition-all hover:border-orange-200 hover:bg-white md:w-auto">
                ...
                <TextHeading className="mb-4 text-slate-900">Interactive Map</TextHeading>
                <TextBody className="text-slate-500 leading-relaxed text-base">
                  Live points of interest curated for travelers, including the best food and sights in Legazpi.
                </TextBody>
              </div>
              ...
              <div className="group w-[88vw] shrink-0 snap-center rounded-[2.5rem] border border-slate-100 bg-white/60 p-10 backdrop-blur-sm transition-all hover:border-emerald-200 hover:bg-white md:w-auto">
                ...
                <TextHeading className="mb-4 text-slate-900">Seamless Itinerary</TextHeading>
                <TextBody className="text-slate-500 leading-relaxed text-base">
                  A centralized place to manage your basecamp, daily schedules, and trip history.
                </TextBody>
              </div>
