        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex justify-end">
            <div className="max-w-[85%] rounded-2xl bg-gray-100 px-4 py-3 text-sm text-gray-800">
              I want to go to the Bahamahas and check out some interesting
              beaches!
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <div className="flex flex-col gap-3">
              <div className="text-sm leading-relaxed text-gray-800">
                The <span className="font-semibold">Bahamas</span> is full of
                surprises. If you're looking for something specific—maybe a
                hidden gem, a new itinerary idea, or help with your plans—just
                let me know!
                <br />
                What would you like to explore or plan next for your trip to the{" "}
                <span className="font-semibold">Bahamas</span>?
              </div>
